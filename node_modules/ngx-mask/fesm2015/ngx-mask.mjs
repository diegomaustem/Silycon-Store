...
class NgxMaskService extends NgxMaskApplierService {
    ...
    cb = () => { }) {
        ...
        if (backspaced &&
            this.specialCharacters.indexOf((_b = this.maskExpression[position]) !== null && _b !== void 0 ? _b : "" /* MaskExpression.EMPTY_STRING */) !== -1 &&
            this.showMaskTyped) {
    ...
    _checkPatternForSpace() {
        ...
        for (const key in this.patterns) {
            ...
            if (this.patterns[key] && ((_a = this.patterns[key]) === null || _a === void 0 ? void 0 : _a.hasOwnProperty('pattern'))) {
                ...
                if ((patternString === null || patternString === void 0 ? void 0 : patternString.includes(" " /* MaskExpression.WHITE_SPACE */)) &&
                ...
                if (this.showMaskTyped &&
                    ...
                    if (this._code !== "Backspace" /* MaskExpression.BACKSPACE */) {
                        if (!checkSymbols && !checkSpecialCharacter && selectRangeBackspace) {
                            ...
                            this._maskService._checkSymbolMask(el.value, (_e = this._maskService.maskExpression[position - 1 - prefixLength]) !== null && _e !== void 0 ? _e : "" /* MaskExpression.EMPTY_STRING */)) {
                            this._maskService.actualValue =
                                this.prefix +
                                    el.value +
                                    this._maskService.maskIsShown.slice(1, this._maskService.maskIsShown.length) +
        ...
        this._maskExpressionArray.some((mask) => {
            ...
            if ((specialChart && this._inputValue && !mask.includes("S" /* MaskExpression.LETTER_S */)) ||
                ...
                const check = (_d = this._maskService
                    .removeMask(this._inputValue)) === null || _d === void 0 ? void 0 : _d.split("" /* MaskExpression.EMPTY_STRING */).every((character, index) => {
